...
#Remove Items
recipes.addShapeless(<simplyjetpacks:itemjetpack:0>.withTag({display:{Lore:["Use this Recipe incase your Creative Jetpack breaks from overcharging"]}}), [<simplyjetpacks:itemjetpack:0>.marked("jetpack")],
