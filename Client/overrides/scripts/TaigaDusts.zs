...
mods.immersiveengineering.Crusher.addRecipe(<taiga:aurorium_dust>*2, <taiga:aurorium_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:jauxum_dust>*2, <taiga:jauxum_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:ovium_dust>*2, <taiga:ovium_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:karmesine_dust>*2, <taiga:karmesine_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:vibranium_dust>*2, <taiga:vibranium_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:valyrium_dust>*2, <taiga:valyrium_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:duranite_dust>*2, <taiga:duranite_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:prometheum_dust>*2, <taiga:prometheum_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:eezo_dust>*2, <taiga:eezo_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:abyssum_dust>*2, <taiga:abyssum_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:osram_dust>*2, <taiga:osram_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:uru_dust>*2, <taiga:uru_ore>, 3048);
mods.immersiveengineering.Crusher.addRecipe(<taiga:palladium_dust>*2, <taiga:palladium_ore>, 3048);
