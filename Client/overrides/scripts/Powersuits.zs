...
recipes.addShaped(<powersuits:power_fist>, [[<ore:ingotEndSteel>, <openmodularturrets:intermediate_tiered:9>, <enderio:item_alloy_ingot:8>], [null, <techreborn:advanceddrill>.withEmptyTag(), null], [null, <ore:ingotVibrantAlloy>, null]]);
